...
/** 管理者専用の面談パック管理。認可・入力検証後の処理をActionに委譲する。 */
class MeetingPackController extends Controller
{
    public function index(IndexRequest $request, IndexAction $action): View
    {
        ...
        return view('meeting-pack.management.index', [
            'plans' => $action($validated['keyword'] ?? null, $validated['status'] ?? null),
    ...
    public function publish(Request $request, MeetingPack $plan, PublishAction $action): RedirectResponse
    {
    ...
    public function archive(Request $request, MeetingPack $plan, ArchiveAction $action): RedirectResponse
    {
    ...
    public function unarchive(Request $request, MeetingPack $plan, UnarchiveAction $action): RedirectResponse
    {
