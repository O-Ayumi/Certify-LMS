...
/** 管理者専用のプラン管理。認可・入力検証後の処理をActionに委譲する。 */
class PlanController extends Controller
{
    ...
    public function publish(Request $request, Plan $plan, PublishAction $action): RedirectResponse
    {
    ...
    public function archive(Request $request, Plan $plan, ArchiveAction $action): RedirectResponse
    {
    ...
    public function unarchive(Request $request, Plan $plan, UnarchiveAction $action): RedirectResponse
    {
